...
- **Technical / instrument** — dense data, dark surfaces, diagrams that actually explain the system; monospace details only when the audience itself reads code (commitment 4).
